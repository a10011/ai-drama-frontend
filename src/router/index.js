...
const routes = [
  ...
  { path: '/create/pro', name: 'Studio', component: StudioPage, meta: { title: '专业创作' } },
  ...
  { path: '/script-chat', name: 'ScriptChat', component: () => import('@/views/ScriptChat.vue'), meta: { title: '✍️ 写剧本' } },
]
